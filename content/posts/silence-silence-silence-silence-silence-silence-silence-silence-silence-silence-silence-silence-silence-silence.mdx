...
I am thinking of making a mail server (mostly for myself) because I don't want to pay Zoho (my current mail provider). Unfortunately, I havent had that much luck seeing any good mail servers with relatively simple install steps, so if you have any please send it to exerra@exerra.xyz :)\
...
If you want to support me or the work I do, you can always donate either on Kofi, LiberaPay or directly thru Paypal\
**TODO: INCLUDE LINKS TO THESE!!!!!!!!**

If you're thinking of using DigitalOcean, you can use my promo code to get 25 USD (and I will get 25 USD too!) in credits.
