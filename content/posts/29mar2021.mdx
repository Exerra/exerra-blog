...
I changed how Karen Bot reads commands which was something I was putting off for a loooooong time 😅<br>
Thankfully I only had to change around 50 files so it only took around a day 📆<br>
...
I have opened up the profile endpoints for restricted use! 😄<br>
Yeah that's right. You need 24/7 profile hosting that is shared across multiple services? My API is the way to go then!<br>
...
> Where you want to use the API: \[Description of where you want to use the API]<br>
> Project link/demo: \[Link to demo or code]<br>
...
I have created a CDN! The link is "[cdn.exerra.xyz/files/](https://cdn.exerra.xyz/files/)". I like to put mp4 memes there.<br>
...
Remember when I ranted about prices? Yeah me too<br>
